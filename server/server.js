    ...
    try {
        const completion = await groq.chat.completions.create({
            messages: [
                {
                    role: "system",
                    content: `Briefly explain why ${correctAnswer} is the correct answer for ${question}. The answer should be a maximum of 3 sentences long. In one sentence, also explain why ${userAnswer} is incorrect.`
                },
            ],
            model: "llama3-8b-8192",
        });
